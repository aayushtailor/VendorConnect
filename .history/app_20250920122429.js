...
return `
  <div data-aos="fade-up" data-aos-delay="${v.id * 100}" 
       class="bg-white/30 backdrop-blur-md rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition duration-300">
    ...
  </div>
`;
...
document.addEventListener('DOMContentLoaded', ()=>{
  ...
  document.getElementById('searchInput').onkeyup = (e)=>{ if(e.key==='Enter') render(); };

  document.getElementById('openRegister').onclick = ()=> alert("Registration form coming soon!");
});
// Navbar Mobile Menu
document.addEventListener("DOMContentLoaded", () => {
